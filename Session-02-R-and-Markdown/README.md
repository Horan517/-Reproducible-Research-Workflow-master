...
\begin{equation} label{eq:1}MC=\frac{n}{\sum\_{i}{\sum\_{j}{w_{ij}}}}\frac{x'Wx}{x'x}\end{equation}
...
>
对于块状公式，可以使用双美元符号 "\$$\.\.\.$\$" 将整个公式包围，这样 MacDown 会正确识别为 LaTeX 公式，而不会将其中的内容误识别为 Markdown 语法。  
或者也可以在出现歧义的"_"前面加转义符号"\"
...
8. Once you have done this, knit your document to PDF and email to both instructors. (可以交html文件，只要能正常打开就行)
